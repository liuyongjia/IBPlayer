...
import com.example.ibplayer.page.YulePageContainer;
...
public class YuleActivity extends FragmentActivity{
	...
	private void initData() {
		...
		transaction.replace(R.id.fl_main, new YulePageContainer(YuleActivity.this));
		transaction.commit();
