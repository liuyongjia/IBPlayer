...
import com.example.ibplayer.page.TechnologyPageContainer;
...
public class TechnologyActivity extends FragmentActivity{
	...
	private void initData() {
		...
		transaction.replace(R.id.fl_main, new TechnologyPageContainer(TechnologyActivity.this));
		transaction.commit();
