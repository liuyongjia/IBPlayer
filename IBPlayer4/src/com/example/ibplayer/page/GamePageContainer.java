...
public class GamePageContainer extends Fragment{

	List<BaseFragment> list = new ArrayList<BaseFragment>();
	Activity mActivity;
	private static final String[] CONTENT = new String[] { "全区动态", "单机联机", "网络游戏","电子竞技"};
	public GamePageContainer(Activity activity) {
		super();
		mActivity = activity;
	}
	...
	private void initData() {
		...
		String url_quanqu = UrlUtil.HOST+UrlUtil.URL_YOU_XI ;
		String url_danji = UrlUtil.HOST+UrlUtil.URL_DAN_JI ;
		String url_wangluo = UrlUtil.HOST+UrlUtil.URL_WANG_LUO_YOU_XI ;
		String url_jingji = UrlUtil.HOST+UrlUtil.URL_DIAN_ZI_JING_JI ;
		list.add(new DivBAanguimi(mActivity,url_quanqu));
		list.add(new DivBAanguimi(mActivity,url_danji));
		list.add(new DivBAanguimi(mActivity,url_wangluo));
		list.add(new DivBAanguimi(mActivity,url_jingji));
	}
